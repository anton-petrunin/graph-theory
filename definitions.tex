...
\begin{tikzpicture}[scale=1.6,
  ...
  \node[main node] (1) at (.5,5/6) {{\small$\tfrac{wgc{*}}{}$}};
  \node[main node] (2) at (1,0){{\small$\tfrac{wc}{g{*}}$}};
  \node[main node] (3) at (2,0){{\small$\tfrac{wc{*}}{g}$}};
  \node[main node] (4) at (2.5,5/6){{\small$\tfrac{w}{gc{*}}$}};
 \node[main node] (5) at (2.5,-5/6){{\small$\tfrac{c}{gw{*}}$}};
  \node[main node] (6) at (3.5,-5/6){{\small$\tfrac{cg{*}}{w}$}};
  \node[main node] (7) at (3.5,5/6){{\small$\tfrac{wg{*}}{c}$}};
  \node[main node] (8) at (4,0){{\small$\tfrac{g}{wc{*}}$}};
  \node[main node] (9) at (5,0){{\small$\tfrac{g{*}}{wc}$}};
  \node[main node] (10) at (5.5,-5/6){{\small$\tfrac{}{wgc{*}}$}};
  \path[every node/.style={font=\sffamily\small}]
