...
In order to prove it, one has to prove two inequalities $r(4,4)\z\ge 18$ and $r(4,4)\z\le 18$.
...
To describe the concept, let us consider the following {}\emph{random process} that generates a graph $G_n$ with $n$ vertexes.
