...
\parbf{\ref{ex:not-confluent}.}
Try to construct such system with four objects,
two irreducible and two reducible.

\parbf{\ref{ex:convergent}.}
\textit{\ref{ex:convergent:a}} It is terminating but not confluent.

\parit{Remark.} Note that the systems in \ref{em:baaba>a}, \ref{em:baaba>a,baaa>aaba}, and \textit{\ref{ex:convergent:a}} have the same equivalence relation $\sim$.
