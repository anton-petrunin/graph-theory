...
\begin{lpic}[t(-2 mm),b(0 mm),r(0 mm),l(0 mm)]{pics/deletion-contraction(1)}
\lbl[tr]{4,10;$G$}
...
\begin{thm}{Deletion-plus-contraction formula}
...
The \index{delection-plus-contraction}\emph{delection-plus-contraction} formula together with Kirchhoff's rules were used in the solution of the so called \emph{squaring the square problem}.
