...
The so called \index{nearest neighbor algorithm}\emph{nearest neighbor algorithm} gives a heuristic way to find a Hamiltonian cycle with small (but not necessary smallest) weight.
