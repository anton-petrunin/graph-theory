...
A Rado graph is a countable graph satisfying the following property:
...
The property in the definition will be called \index{Rado property}\emph{Rado property}; so we can say that for the sets of vertexes $V$ and $W$ in a graph the Rado property holds or does not hold.
...
The \index{Rado graph}\emph{Rado graph} is also called \emph{Erd\H{o}s–R\'enyi graph} or \emph{random graph};
