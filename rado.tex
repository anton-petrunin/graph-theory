...
Note that if $G$ has $p$ vertexes, then $G'$ has $p+2^p$ vertexes --- it has $p$ vertexes of $G$ and $2^p$ additional vertexes --- one for each subset of $p$ vertexes of $G$ (including the empty set).
