...
The proof below uses the same construction as in the proof of Theorem~\ref{thm:rado-subgraph}, but it is applied \textit{back and forth} to ensure that the constructed subgraphs contain all the vertexes of the original graph.
