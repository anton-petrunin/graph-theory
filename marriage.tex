...
Further the total number of edges in $Q', P_1',P_2\dots,P_m$
is smaller than in but the original collection $Q, P_1,P_2\dots,P_m$;
indeed we discarded the part of $P_1$ from $w$ to $v$.
...
\begin{figure}[h!]
\centering
\begin{lpic}[t(-0 mm),b(0 mm),r(0 mm),l(0 mm)]{mppics/pic-6(1)}
\end{lpic}
\end{figure}
An example of this procedure two paths $P_1$ and $Q$ is shown on the diagram;
$P_1$ is marked in bold.
