...
\[E(x)=e^{A(x)}\] is another power series which is obtained by pluging $A(x)$ instead of $x$ in the power series of exponent:
...
\[r_n=n\cdot s(K_n).\]
This way we get yet another proof of the Cayley formula (\ref{thm:cayley}) \[s(K_n)=n^{n-2}.\]
