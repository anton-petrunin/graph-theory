...
Recall that the \index{double factorial}\emph{double factorial} is defined as the product of all the integers from $1$ up to some non-negative integer $n$ that have the same parity (odd or even) as $n$;
...
\item Count the number of 2-factors in $K_1,\dots,K_6$ by hands, and compare it to the result in part \ref{ex:2-factor:recursive}.
