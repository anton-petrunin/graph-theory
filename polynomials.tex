...
indeed in the obtained tree $x$ has degree 3 while $y$ and $z$ have degree $2$.
...
Note that $S_G(x,y,z,u,v,w)$ does not depend on $u$, $v$ and $w$ since the corresponding vertexes have degree 1 in any spanning tree.
...
That is, any permutation of values $x_1,\dots, x_p$ does not change $P(x_1,\dots,x_p)$ and after combining of like terms, each monomial in $P$ has total degree $p-2$.
